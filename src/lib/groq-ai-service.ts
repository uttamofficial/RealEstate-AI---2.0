...
Please write in a professional, conversational tone as an expert real estate advisor. Use specific numbers, percentages, and actionable insights. Structure your response with clear sections and bullet points for easy reading. Use plain text formatting only - no markdown, no bold text, no special symbols except bullet points (•).
          ...
          const response = await fetch(`${this.BASE_URL}/chat/completions`, {
            ...
            body: JSON.stringify({
              ...
              messages: [
                {
                  role: 'system',
                  content: 'You are RealEstate AI Agent v3.0, an expert real estate investment advisor with deep market knowledge, financial analysis expertise, and strategic investment planning capabilities. Provide comprehensive, actionable insights for real estate investors. IMPORTANT: Use plain text format only - no markdown, no bold text, no asterisks, no special formatting symbols. Use simple bullet points with • symbol and clear section headers in plain text.'
                },
                {
                  role: 'user',
                  content: prompt
