...
export default function DealsPage() {
  ...
  const filteredDeals = useMemo(() => {
    ...
    return deals;
  }, [allDeals, preferences, searchQuery, sortBy, sortOrder]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{dealStats.total}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{dealStats.avgCapRate.toFixed(1)}%</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{dealStats.highScoreDeals}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-lg">
                <div className="flex items-center space-x-2">
                  <div className="h-5 w-5 rounded-full bg-gradient-to-r from-blue-600 to-purple-600"></div>
                  <div>
                    <p className="text-sm text-gray-600">Total Value</p>
                    <p className="text-xl font-bold text-gray-900">₹{(dealStats.totalValue / 10000000).toFixed(1)}Cr</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Controls Section */}
        <div className="mb-6 bg-white/80 backdrop-blur-sm rounded-xl border border-white/50 shadow-lg p-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            {isLoading ? (
              <div className="flex justify-center items-center h-64 bg-white/80 backdrop-blur-sm rounded-xl border border-white/50 shadow-lg">
              ...
              <div className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-xl border border-white/50 shadow-lg">
